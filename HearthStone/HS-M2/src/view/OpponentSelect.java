...
public class OpponentSelect extends JFrame {
	...
	public OpponentSelect()
	{
		...
		Hunter.setActionCommand("oHunter");
		...
		Paladin.setActionCommand("oPaladin");
		...
		Priest.setActionCommand("oPriest");
		...
		Warlock.setActionCommand("oWarlock");
